<!--basic structure of the comment network-->
...
<head>
    ...
    />
    <style><#include "css/commentStyle.css"></style>
    <title>${title}</title>
</head>
<body>
...
<div class="mainContent">
    <div class="setFilter">
        ...
        <button onclick="getProtocol()">submit</button>
    </div>
    <div class="filtercheck">
        <button id="wp19" onclick="getSpecific(1000,1508796000000,1635199200000)">Wahlperiode19</button>
        <button id="wp20" onclick="getSpecific(1000,1635199200000,2665525600000)">Wahlperiode20</button>
        <button id="pos">positiv</button>
        <button id="neg">negativ</button>
        <button id="net">neutral</button>
        <button id="SPD">SPD</button>
        <button id="CDU">CDU</button>
        <button id="FDP">FDP</button>
        <button id="GRÜNEN">GRÜNEN</button>
        <button id="LINKE">DIE LINKE</button>
        <button id="AfD">AfD</button>
    </div>
    <!--end of filter-->
</div>
...
<div id="protocolGraph"></div>

</body>


<script><#include "js/commentVis.js"></script>
<script>
    //This method is called when the page is fully loaded.
    $(document).ready(function () {
        loadCommentNet(500,1,2665525600000);
    });
</script>
</html>
